    ...
    <DashboardLayout activeMenu="Users">
      <div className="p-6 bg-gray-50 min-h-screen font-sans">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">Create, view, and manage user accounts and access.</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="w-full lg:w-1/3 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="text-red-500 border border-red-500 px-3 py-1.5 rounded text-xs font-semibold hover:bg-red-50 transition flex items-center"
              >
            ...
            <form onSubmit={handleAddUser}>
              ...
              <div className="mb-6">
                ...
                <input
                  type="email"
                  className="w-full border border-gray-300 rounded-md p-2 text-sm focus:ring-2 focus:ring-red-200 focus:border-red-400 outline-none transition"
          ...
          <div className="w-full lg:w-2/3 bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-full">
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <div className="relative w-full sm:w-64">
                  ...
                  <input
                    ...
                    className="pl-9 pr-4 py-2 border border-gray-300 rounded-lg w-full text-sm focus:ring-2 focus:ring-gray-200 outline-none"
                    value={search}
                    onChange={e => setSearch(e.target.value)}
                  />
                </div>
                <select className="border border-gray-300 rounded-lg text-sm px-3 bg-white text-gray-600 outline-none">
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="text-sm text-gray-700">
                  {loading ? (
                    ...
                    <tr key={user._id} className="border-b border-gray-50 last:border-0 hover:bg-gray-50 transition group">
                      ...
                      <td className="py-4 pl-2 font-medium flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          <span className="text-gray-800 font-semibold flex items-center gap-2">
                            {user.name}
                            <FaLock className="text-gray-300 text-xs" title="Credentials Set" />
                          </span>
                        </div>
                      </td>
            ...
            {filteredUsers.length > 5 && (
              <div className="mt-4 flex justify-between items-center text-xs text-gray-400">
                ...
                <div className="flex gap-1">
                  <button className="px-2 py-1 border rounded hover:bg-gray-50"><FaChevronLeft /></button>
                  <button className="px-2 py-1 border rounded hover:bg-gray-50"><FaChevronRight /></button>
                </div>
              </div>
            )}
          </div>
